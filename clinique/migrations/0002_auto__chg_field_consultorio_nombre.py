...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Consultorio.nombre'
        db.alter_column('clinique_consultorio', 'nombre', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Consultorio.nombre'
        db.alter_column('clinique_consultorio', 'nombre', self.gf('django.db.models.fields.CharField')(max_length=1))

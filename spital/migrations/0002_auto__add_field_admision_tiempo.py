...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Admision.tiempo'
        db.add_column('spital_admision', 'tiempo', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Admision.tiempo'
        db.delete_column('spital_admision', 'tiempo')

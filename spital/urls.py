...
urlpatterns = [
    ...
    url(r'^(?P<pk>\d+)/autorizacion$',
        views.AdmisionDetailView.as_view(template_name="admision/autorizacion.html"),
        name='admision-autorizacion'),
    
    url(r'^(?P<pk>\d+)/fiadores$',
        views.AdmisionDetailView.as_view(template_name="admision/admision_fiadores.html"),
    ...
    url(r'^(?P<pk>\d+)/referencias$',
        views.AdmisionDetailView.as_view(template_name="admision/admision_referencias.html"),

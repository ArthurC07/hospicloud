...
class Admision(models.Model):
    ...
    paciente = models.ManyToOneRel(Persona, related_name='admisiones')
    fiadores = models.ManyToManyField(Persona, related_name='admisiones_fiadas')
    referencia = models.ManyToOneRel(Persona, related_name='admisiones_r')
    ...
    admitio = models.ManyToOneRel(User)
...
class Sumario(models.Model):
    ...
    admision = models.OneToOneRel(Admision)
    diagnostico = models.CharField(max_length=200, blank=True)

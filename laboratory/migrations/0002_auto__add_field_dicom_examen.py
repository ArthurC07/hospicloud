...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('laboratory_dicom', 'examen', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='dicoms', null=True, to=orm['laboratory.Examen']), keep_default=False)
    ...
    models = {
        ...
        'laboratory.dicom': {
            ...
            'descripcion': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'examen': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'dicoms'", 'null': 'True', 'to': "orm['laboratory.Examen']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

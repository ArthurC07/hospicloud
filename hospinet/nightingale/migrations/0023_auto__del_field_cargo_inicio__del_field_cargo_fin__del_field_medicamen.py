...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Cargo.inicio'
        db.delete_column(u'nightingale_cargo', 'inicio')

        # Deleting field 'Cargo.fin'
        db.delete_column(u'nightingale_cargo', 'fin')

        # Deleting field 'Medicamento.control'
        db.delete_column(u'nightingale_medicamento', 'control')

        # Deleting field 'Medicamento.fecha_y_hora'
        db.delete_column(u'nightingale_medicamento', 'fecha_y_hora')

        # Deleting field 'Medicamento.nombre'
        db.delete_column(u'nightingale_medicamento', 'nombre')

        # Deleting field 'Medicamento.dias'
        db.delete_column(u'nightingale_medicamento', 'dias')

        # Adding field 'Medicamento.created'
        db.add_column(u'nightingale_medicamento', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'Medicamento.modified'
        db.add_column(u'nightingale_medicamento', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'Medicamento.cargo'
        db.add_column(u'nightingale_medicamento', 'cargo',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='medicamentos', null=True, to=orm['inventory.ItemTemplate']),
                      keep_default=False)

        # Adding field 'Medicamento.cantidad'
        db.add_column(u'nightingale_medicamento', 'cantidad',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Dosis.administrador'
        db.delete_column(u'nightingale_dosis', 'administrador_id')

        # Deleting field 'Dosis.fecha_y_hora'
        db.delete_column(u'nightingale_dosis', 'fecha_y_hora')

        # Adding field 'Dosis.created'
        db.add_column(u'nightingale_dosis', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'Dosis.modified'
        db.add_column(u'nightingale_dosis', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Cargo.inicio'
        db.add_column(u'nightingale_cargo', 'inicio',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'Cargo.fin'
        db.add_column(u'nightingale_cargo', 'fin',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'Medicamento.control'
        db.add_column(u'nightingale_medicamento', 'control',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Medicamento.fecha_y_hora'
        db.add_column(u'nightingale_medicamento', 'fecha_y_hora',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'Medicamento.nombre'
        db.add_column(u'nightingale_medicamento', 'nombre',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Medicamento.dias'
        db.add_column(u'nightingale_medicamento', 'dias',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Medicamento.created'
        db.delete_column(u'nightingale_medicamento', 'created')

        # Deleting field 'Medicamento.modified'
        db.delete_column(u'nightingale_medicamento', 'modified')

        # Deleting field 'Medicamento.cargo'
        db.delete_column(u'nightingale_medicamento', 'cargo_id')

        # Deleting field 'Medicamento.cantidad'
        db.delete_column(u'nightingale_medicamento', 'cantidad')

        # Adding field 'Dosis.administrador'
        db.add_column(u'nightingale_dosis', 'administrador',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='dosis_administradas', null=True, to=orm['auth.User'], blank=True),
                      keep_default=False)

        # Adding field 'Dosis.fecha_y_hora'
        db.add_column(u'nightingale_dosis', 'fecha_y_hora',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Deleting field 'Dosis.created'
        db.delete_column(u'nightingale_dosis', 'created')

        # Deleting field 'Dosis.modified'
        db.delete_column(u'nightingale_dosis', 'modified')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Medicamento.ultima_dosis'
        db.add_column(u'nightingale_medicamento', 'ultima_dosis',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'Medicamento.proxima_dosis'
        db.add_column(u'nightingale_medicamento', 'proxima_dosis',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Adding field 'Medicamento.suministrado'
        db.add_column(u'nightingale_medicamento', 'suministrado',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Medicamento.ultima_dosis'
        db.delete_column(u'nightingale_medicamento', 'ultima_dosis')

        # Deleting field 'Medicamento.proxima_dosis'
        db.delete_column(u'nightingale_medicamento', 'proxima_dosis')

        # Deleting field 'Medicamento.suministrado'
        db.delete_column(u'nightingale_medicamento', 'suministrado')

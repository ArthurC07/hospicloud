...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NotaEnfermeria.cerrada'
        db.add_column('nightingale_notaenfermeria', 'cerrada',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NotaEnfermeria.cerrada'
        db.delete_column('nightingale_notaenfermeria', 'cerrada')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cargo.cargo'
        db.alter_column('nightingale_cargo', 'cargo', self.gf('django.db.models.fields.TextField')(max_length=200))
        # Deleting field 'OrdenMedica.doctor'
        db.delete_column('nightingale_ordenmedica', 'doctor')

        # Deleting field 'Dosis.momento'
        db.delete_column('nightingale_dosis', 'momento')

        # Adding field 'Dosis.fecha_y_hora'
        db.add_column('nightingale_dosis', 'fecha_y_hora',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Cargo.cargo'
        db.alter_column('nightingale_cargo', 'cargo', self.gf('django.db.models.fields.CharField')(max_length=200))
        # Adding field 'OrdenMedica.doctor'
        db.add_column('nightingale_ordenmedica', 'doctor',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Dosis.momento'
        db.add_column('nightingale_dosis', 'momento',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime.now),
                      keep_default=False)

        # Deleting field 'Dosis.fecha_y_hora'
        db.delete_column('nightingale_dosis', 'fecha_y_hora')

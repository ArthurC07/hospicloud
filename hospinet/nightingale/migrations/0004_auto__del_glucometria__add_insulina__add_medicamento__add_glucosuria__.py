...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Insulina'
        db.create_table('nightingale_insulina', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('admision', self.gf('django.db.models.fields.related.ForeignKey')(related_name='insulina', to=orm['spital.Admision'])),
        ...
        db.send_create_signal('nightingale', ['Insulina'])

        # Adding model 'Medicamento'
        db.create_table('nightingale_medicamento', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('admision', self.gf('django.db.models.fields.related.ForeignKey')(related_name='medicamentos', to=orm['spital.Admision'])),
            ('medicamento', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('hora', self.gf('django.db.models.fields.TimeField')(default=datetime.datetime.now)),
        ))
        db.send_create_signal('nightingale', ['Medicamento'])

        # Adding model 'Glucosuria'
        db.create_table('nightingale_glucosuria', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('admision', self.gf('django.db.models.fields.related.ForeignKey')(related_name='glucosurias', to=orm['spital.Admision'])),
            ('fecha_y_hora', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('control', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('observacion', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
        ))
        db.send_create_signal('nightingale', ['Glucosuria'])

        # Adding model 'Glicemia'
        db.create_table('nightingale_glicemia', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('admision', self.gf('django.db.models.fields.related.ForeignKey')(related_name='glicemias', to=orm['spital.Admision'])),
            ('fecha_y_hora', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('control', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('observacion', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
        ))
        db.send_create_signal('nightingale', ['Glicemia'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Insulina'
        db.delete_table('nightingale_insulina')

        # Deleting model 'Medicamento'
        db.delete_table('nightingale_medicamento')

        # Deleting model 'Glucosuria'
        db.delete_table('nightingale_glucosuria')

        # Deleting model 'Glicemia'
        db.delete_table('nightingale_glicemia')
    ...
    models = {
        ...
        'nightingale.medicamento': {
            ...
            'hora': ('django.db.models.fields.TimeField', [], {'default': 'datetime.datetime.now'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'medicamento': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'})
        },

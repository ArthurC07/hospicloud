...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Dosis.suministrada'
        db.delete_column('nightingale_dosis', 'suministrada')

        # Adding field 'Dosis.estado'
        db.add_column('nightingale_dosis', 'estado',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Dosis.recomendacion'
        db.add_column('nightingale_dosis', 'recomendacion',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Dosis.administrador'
        db.add_column('nightingale_dosis', 'administrador',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='dosis_administradas', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Dosis.suministrada'
        db.add_column('nightingale_dosis', 'suministrada',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Dosis.estado'
        db.delete_column('nightingale_dosis', 'estado')

        # Deleting field 'Dosis.recomendacion'
        db.delete_column('nightingale_dosis', 'recomendacion')

        # Deleting field 'Dosis.administrador'
        db.delete_column('nightingale_dosis', 'administrador_id')
    ...
    models = {
        ...
        'nightingale.cargo': {
            ...
            'cargo': ('django.db.models.fields.TextField', [], {'max_length': '200'}),
        ...
        'nightingale.dosis': {
            ...
            'fecha_y_hora': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime.now'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

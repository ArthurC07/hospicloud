...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Honorario.usuario'
        db.add_column(u'nightingale_honorario', 'usuario',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='honorarios', null=True, to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Honorario.usuario'
        db.delete_column(u'nightingale_honorario', 'usuario_id')

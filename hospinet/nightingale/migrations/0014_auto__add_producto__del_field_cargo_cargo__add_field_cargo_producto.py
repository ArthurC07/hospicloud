...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('nightingale_cargo', 'cargo')

        # Adding field 'Cargo.producto'
        db.add_column('nightingale_cargo', 'producto',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='cargos', null=True, to=orm['nightingale.Producto']),
                      keep_default=False)
    ...
    models = {
        ...
        'nightingale.cargo': {
            ...
            'producto': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'cargos'", 'null': 'True', 'to': "orm['nightingale.Producto']"}),

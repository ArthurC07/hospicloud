...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'OxigenoTerapia'
        db.create_table(u'nightingale_oxigenoterapia', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('admision', self.gf('django.db.models.fields.related.ForeignKey')(related_name='oxigeno_terapias', to=orm['spital.Admision'])),
            ('cargo', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='oxigeno_terapias', null=True, to=orm['inventory.ItemTemplate'])),
            ('terminada', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'nightingale', ['OxigenoTerapia'])


    def backwards(self, orm):
        # Deleting model 'OxigenoTerapia'
        db.delete_table(u'nightingale_oxigenoterapia')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'SignoVital.presion'
        db.delete_column('nightingale_signovital', 'presion')

        # Adding field 'SignoVital.presion_sistolica'
        db.add_column('nightingale_signovital', 'presion_sistolica',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2),
                      keep_default=False)

        # Adding field 'SignoVital.presion_diastolica'
        db.add_column('nightingale_signovital', 'presion_diastolica',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'SignoVital.presion'
        db.add_column('nightingale_signovital', 'presion',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=4, decimal_places=2),
                      keep_default=False)

        # Deleting field 'SignoVital.presion_sistolica'
        db.delete_column('nightingale_signovital', 'presion_sistolica')

        # Deleting field 'SignoVital.presion_diastolica'
        db.delete_column('nightingale_signovital', 'presion_diastolica')
    ...
    models = {
        ...
        'nightingale.signovital': {
            ...
            'presion_diastolica': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '4', 'decimal_places': '2'}),
            'presion_sistolica': ('django.db.models.fields.DecimalField', [], {'null': 'True', 'max_digits': '4', 'decimal_places': '2'}),

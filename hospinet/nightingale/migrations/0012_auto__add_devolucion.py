...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('nightingale_devolucion', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('admision', self.gf('django.db.models.fields.related.ForeignKey')(related_name='devoluciones', to=orm['spital.Admision'])),
            ('descripcion', self.gf('django.db.models.fields.TextField')(max_length=200, null=True, blank=True)),
            ('fecha_y_hora', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('usuario', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='devoluciones', null=True, to=orm['auth.User'])),
        ))
        db.send_create_signal('nightingale', ['Devolucion'])


    def backwards(self, orm):
        # Deleting model 'Devolucion'
        db.delete_table('nightingale_devolucion')

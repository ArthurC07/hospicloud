...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cargo.cantidad'
        db.alter_column(u'nightingale_cargo', 'cantidad', self.gf('django.db.models.fields.DecimalField')(max_digits=6, decimal_places=2))

    def backwards(self, orm):

        # Changing field 'Cargo.cantidad'
        db.alter_column(u'nightingale_cargo', 'cantidad', self.gf('django.db.models.fields.DecimalField')(max_digits=5, decimal_places=2))
    ...
    models = {
        ...
        u'nightingale.cargo': {
            ...
            'cantidad': ('django.db.models.fields.DecimalField', [], {'default': '1', 'max_digits': '6', 'decimal_places': '2'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Cargo.fecha_y_hora'
        db.delete_column(u'nightingale_cargo', 'fecha_y_hora')

        # Adding field 'Cargo.created'
        db.add_column(u'nightingale_cargo', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'Cargo.modified'
        db.add_column(u'nightingale_cargo', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Cargo.fecha_y_hora'
        db.add_column(u'nightingale_cargo', 'fecha_y_hora',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Deleting field 'Cargo.created'
        db.delete_column(u'nightingale_cargo', 'created')

        # Deleting field 'Cargo.modified'
        db.delete_column(u'nightingale_cargo', 'modified')

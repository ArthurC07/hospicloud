...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Medicamento.veces'
        db.delete_column(u'nightingale_medicamento', 'veces')

        # Adding field 'Medicamento.unidades'
        db.add_column(u'nightingale_medicamento', 'unidades',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Medicamento.repeticiones'
        db.add_column(u'nightingale_medicamento', 'repeticiones',
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Medicamento.veces'
        db.add_column(u'nightingale_medicamento', 'veces',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Medicamento.unidades'
        db.delete_column(u'nightingale_medicamento', 'unidades')

        # Deleting field 'Medicamento.repeticiones'
        db.delete_column(u'nightingale_medicamento', 'repeticiones')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('nightingale_medicamento', 'fecha_y_hora',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)


        # Changing field 'Dosis.fecha_y_hora'
        db.alter_column('nightingale_dosis', 'fecha_y_hora', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):
        # Deleting field 'Medicamento.fecha_y_hora'
        db.delete_column('nightingale_medicamento', 'fecha_y_hora')


        # Changing field 'Dosis.fecha_y_hora'
        db.alter_column('nightingale_dosis', 'fecha_y_hora', self.gf('django.db.models.fields.DateField')())

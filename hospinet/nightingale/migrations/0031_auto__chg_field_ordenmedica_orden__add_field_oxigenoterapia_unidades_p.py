...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OrdenMedica.orden'
        db.alter_column(u'nightingale_ordenmedica', 'orden', self.gf('django.db.models.fields.TextField')())
        # Adding field 'OxigenoTerapia.unidades_por_minuto'
        db.add_column(u'nightingale_oxigenoterapia', 'unidades_por_minuto',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'OrdenMedica.orden'
        db.alter_column(u'nightingale_ordenmedica', 'orden', self.gf('django.db.models.fields.CharField')(max_length=200))
        # Deleting field 'OxigenoTerapia.unidades_por_minuto'
        db.delete_column(u'nightingale_oxigenoterapia', 'unidades_por_minuto')

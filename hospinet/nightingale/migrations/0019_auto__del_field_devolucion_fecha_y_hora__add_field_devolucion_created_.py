...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Devolucion.fecha_y_hora'
        db.delete_column(u'nightingale_devolucion', 'fecha_y_hora')

        # Adding field 'Devolucion.created'
        db.add_column(u'nightingale_devolucion', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'Devolucion.modified'
        db.add_column(u'nightingale_devolucion', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'Devolucion.cargo'
        db.add_column(u'nightingale_devolucion', 'cargo',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='devoluciones', null=True, to=orm['inventory.ItemTemplate']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Devolucion.fecha_y_hora'
        db.add_column(u'nightingale_devolucion', 'fecha_y_hora',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now),
                      keep_default=False)

        # Deleting field 'Devolucion.created'
        db.delete_column(u'nightingale_devolucion', 'created')

        # Deleting field 'Devolucion.modified'
        db.delete_column(u'nightingale_devolucion', 'modified')

        # Deleting field 'Devolucion.cargo'
        db.delete_column(u'nightingale_devolucion', 'cargo_id')
    ...
    models = {
        ...
        u'nightingale.cargo': {
            ...
            'cantidad': ('django.db.models.fields.DecimalField', [], {'default': '1', 'max_digits': '5', 'decimal_places': '2'}),
        ...
        u'nightingale.dosis': {
            ...
            'administrador': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'dosis_administradas'", 'null': 'True', 'to': u"orm['auth.User']"}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Sumario.created'
        db.add_column(u'nightingale_sumario', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'Sumario.modified'
        db.add_column(u'nightingale_sumario', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Sumario.created'
        db.delete_column(u'nightingale_sumario', 'created')

        # Deleting field 'Sumario.modified'
        db.delete_column(u'nightingale_sumario', 'modified')

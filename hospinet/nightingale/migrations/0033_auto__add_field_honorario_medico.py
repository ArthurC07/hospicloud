...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Honorario.medico'
        db.add_column(u'nightingale_honorario', 'medico',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Honorario.medico'
        db.delete_column(u'nightingale_honorario', 'medico')

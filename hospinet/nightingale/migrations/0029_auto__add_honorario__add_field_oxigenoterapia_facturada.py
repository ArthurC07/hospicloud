...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Honorario'
        db.create_table(u'nightingale_honorario', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('admision', self.gf('django.db.models.fields.related.ForeignKey')(related_name='honorarios', to=orm['spital.Admision'])),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='honorarios', null=True, to=orm['inventory.ItemTemplate'])),
            ('monto', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2)),
            ('facturada', self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True)),
        ))
        db.send_create_signal(u'nightingale', ['Honorario'])

        # Adding field 'OxigenoTerapia.facturada'
        db.add_column(u'nightingale_oxigenoterapia', 'facturada',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'Honorario'
        db.delete_table(u'nightingale_honorario')

        # Deleting field 'OxigenoTerapia.facturada'
        db.delete_column(u'nightingale_oxigenoterapia', 'facturada')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Medicamento.estado'
        db.add_column('nightingale_medicamento', 'estado',
                      self.gf('django.db.models.fields.IntegerField')(default=1, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Medicamento.estado'
        db.delete_column('nightingale_medicamento', 'estado')

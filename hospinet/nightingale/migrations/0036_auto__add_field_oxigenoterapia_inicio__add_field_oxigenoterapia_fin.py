...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OxigenoTerapia.inicio'
        db.add_column(u'nightingale_oxigenoterapia', 'inicio',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'OxigenoTerapia.fin'
        db.add_column(u'nightingale_oxigenoterapia', 'fin',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OxigenoTerapia.inicio'
        db.delete_column(u'nightingale_oxigenoterapia', 'inicio')

        # Deleting field 'OxigenoTerapia.fin'
        db.delete_column(u'nightingale_oxigenoterapia', 'fin')

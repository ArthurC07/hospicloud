...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NotaEnfermeria.autor'
        db.add_column(u'nightingale_notaenfermeria', 'autor',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NotaEnfermeria.autor'
        db.delete_column(u'nightingale_notaenfermeria', 'autor')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Evolucion.nota'
        db.alter_column(u'nightingale_evolucion', 'nota', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'Evolucion.nota'
        db.alter_column(u'nightingale_evolucion', 'nota', self.gf('django.db.models.fields.CharField')(max_length=200))

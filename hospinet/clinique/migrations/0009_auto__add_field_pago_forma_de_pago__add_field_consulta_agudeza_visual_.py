...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pago.forma_de_pago'
        db.add_column('clinique_pago', 'forma_de_pago',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1, blank=True),
                      keep_default=False)

        # Adding field 'Consulta.agudeza_visual_ojo_derecho'
        db.add_column('clinique_consulta', 'agudeza_visual_ojo_derecho',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Consulta.agudeza_visual_ojo_izquierdo'
        db.add_column('clinique_consulta', 'agudeza_visual_ojo_izquierdo',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Pago.forma_de_pago'
        db.delete_column('clinique_pago', 'forma_de_pago')

        # Deleting field 'Consulta.agudeza_visual_ojo_derecho'
        db.delete_column('clinique_consulta', 'agudeza_visual_ojo_derecho')

        # Deleting field 'Consulta.agudeza_visual_ojo_izquierdo'
        db.delete_column('clinique_consulta', 'agudeza_visual_ojo_izquierdo')
    ...
    models = {
        ...
        'clinique.cita': {
            ...
            'fecha_y_hora': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 17, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

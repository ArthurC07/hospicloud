...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cargo.cantidad'
        db.add_column(u'clinique_cargo', 'cantidad',
                      self.gf('django.db.models.fields.IntegerField')(default=1),
                      keep_default=False)

        # Adding field 'Consultorio.inventario'
        db.add_column(u'clinique_consultorio', 'inventario',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='consultorios', null=True, to=orm['inventory.Inventario']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cargo.cantidad'
        db.delete_column(u'clinique_cargo', 'cantidad')

        # Deleting field 'Consultorio.inventario'
        db.delete_column(u'clinique_consultorio', 'inventario_id')

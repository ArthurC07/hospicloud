...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Incapacidad'
        db.create_table(u'clinique_incapacidad', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('paciente', self.gf('django.db.models.fields.related.ForeignKey')(related_name='incapacidades', to=orm['clinique.Paciente'])),
            ('consultorio', self.gf('django.db.models.fields.related.ForeignKey')(related_name='incapacidades', to=orm['clinique.Consultorio'])),
            ('descripcion', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'clinique', ['Incapacidad'])


    def backwards(self, orm):
        # Deleting model 'Incapacidad'
        db.delete_table(u'clinique_incapacidad')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field administradores on 'Consultorio'
        m2m_table_name = db.shorten_name(u'clinique_consultorio_administradores')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('consultorio', models.ForeignKey(orm[u'clinique.consultorio'], null=False)),
            ('user', models.ForeignKey(orm[u'auth.user'], null=False))
        ))
        db.create_unique(m2m_table_name, ['consultorio_id', 'user_id'])


    def backwards(self, orm):
        # Removing M2M table for field administradores on 'Consultorio'
        db.delete_table(db.shorten_name(u'clinique_consultorio_administradores'))

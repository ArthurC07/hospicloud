...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cita.consultorio'
        db.add_column(u'clinique_cita', 'consultorio',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='citas', null=True, to=orm['clinique.Consultorio']),
                      keep_default=False)


        # Changing field 'Cita.usuario'
        db.alter_column(u'clinique_cita', 'usuario_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):
        # Deleting field 'Cita.consultorio'
        db.delete_column(u'clinique_cita', 'consultorio_id')


        # Changing field 'Cita.usuario'
        db.alter_column(u'clinique_cita', 'usuario_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['auth.User']))
    ...
    models = {
        ...
        u'clinique.cita': {
            ...
            'paciente': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'citas'", 'null': 'True', 'to': u"orm['clinique.Paciente']"}),
            'usuario': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'citas'", 'null': 'True', 'to': u"orm['auth.User']"})
        },
        u'clinique.consulta': {

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Cargo'
        db.create_table(u'clinique_cargo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('paciente', self.gf('django.db.models.fields.related.ForeignKey')(related_name='cargos', to=orm['clinique.Paciente'])),
            ('tipo', self.gf('django.db.models.fields.related.ForeignKey')(related_name='cargos', to=orm['clinique.TipoCargo'])),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(related_name='consultorio_cargos', to=orm['inventory.ItemTemplate'])),
        ))
        db.send_create_signal(u'clinique', ['Cargo'])

        # Adding model 'OrdenMedica'
        db.create_table(u'clinique_ordenmedica', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('paciente', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ordenes_medicas', to=orm['clinique.Paciente'])),
            ('evolucion', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('orden', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal(u'clinique', ['OrdenMedica'])

        # Adding model 'TipoCargo'
        db.create_table(u'clinique_tipocargo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('descontable', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'clinique', ['TipoCargo'])


    def backwards(self, orm):
        # Deleting model 'Cargo'
        db.delete_table(u'clinique_cargo')

        # Deleting model 'OrdenMedica'
        db.delete_table(u'clinique_ordenmedica')

        # Deleting model 'TipoCargo'
        db.delete_table(u'clinique_tipocargo')

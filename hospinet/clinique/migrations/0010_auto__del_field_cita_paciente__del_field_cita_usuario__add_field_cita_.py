...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Cita.paciente'
        db.delete_column(u'clinique_cita', 'paciente_id')

        # Deleting field 'Cita.usuario'
        db.delete_column(u'clinique_cita', 'usuario_id')

        # Adding field 'Cita.persona'
        db.add_column(u'clinique_cita', 'persona',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='citas', null=True, to=orm['persona.Persona']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Cita.paciente'
        db.add_column(u'clinique_cita', 'paciente',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='citas', null=True, to=orm['clinique.Paciente'], blank=True),
                      keep_default=False)

        # Adding field 'Cita.usuario'
        db.add_column(u'clinique_cita', 'usuario',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='citas', null=True, to=orm['auth.User'], blank=True),
                      keep_default=False)

        # Deleting field 'Cita.persona'
        db.delete_column(u'clinique_cita', 'persona_id')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'LecturaSignos.persona'
        db.add_column(u'clinique_lecturasignos', 'persona',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='lecturas_signos', null=True, to=orm['persona.Persona']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'LecturaSignos.persona'
        db.delete_column(u'clinique_lecturasignos', 'persona_id')

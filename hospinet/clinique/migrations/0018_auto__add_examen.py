...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Examen'
        db.create_table(u'clinique_examen', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('paciente', self.gf('django.db.models.fields.related.ForeignKey')(related_name='', to=orm['clinique.Paciente'])),
        ...
        db.send_create_signal(u'clinique', ['Examen'])


    def backwards(self, orm):
        # Deleting model 'Examen'
        db.delete_table(u'clinique_examen')
    ...
    models = {
        ...
        u'clinique.examen': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'paciente': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "''", 'to': u"orm['clinique.Paciente']"})
        },

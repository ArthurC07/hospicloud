...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Paciente.primera_visita'
        db.add_column('clinique_paciente', 'primera_visita',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Paciente.primera_visita'
        db.delete_column('clinique_paciente', 'primera_visita')
    ...
    models = {
        ...
        'clinique.cita': {
            ...
            'fecha_y_hora': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 15, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

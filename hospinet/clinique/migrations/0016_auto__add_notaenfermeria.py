...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'clinique_notaenfermeria', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('paciente', self.gf('django.db.models.fields.related.ForeignKey')(related_name='notas_enfermeria', to=orm['clinique.Paciente'])),
            ('nota', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('usuario', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='consultorio_notas_enfermeria', null=True, to=orm['auth.User'])),
        ))
        db.send_create_signal(u'clinique', ['NotaEnfermeria'])


    def backwards(self, orm):
        # Deleting model 'NotaEnfermeria'
        db.delete_table(u'clinique_notaenfermeria')

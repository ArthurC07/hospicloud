...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Cita.fecha'
        db.alter_column(u'clinique_cita', 'fecha', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'Cita.fecha'
        db.alter_column(u'clinique_cita', 'fecha', self.gf('django.db.models.fields.DateField')(null=True))

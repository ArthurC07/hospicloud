...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Espera.fecha'
        db.alter_column(u'clinique_espera', 'fecha', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'Espera.fecha'
        db.alter_column(u'clinique_espera', 'fecha', self.gf('django.db.models.fields.DateField')())

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'clinique_reporte', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('consultorio', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='reportes', null=True, to=orm['clinique.Consultorio'])),
            ('archivo', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
        ))
        db.send_create_signal(u'clinique', ['Reporte'])


    def backwards(self, orm):
        # Deleting model 'Reporte'
        db.delete_table(u'clinique_reporte')
    ...
    models = {
        ...
        u'clinique.incapacidad': {
            'Meta': {'ordering': "('-modified', '-created')", 'object_name': 'Incapacidad'},
            'consultorio': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'incapacidades'", 'to': u"orm['clinique.Consultorio']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'descripcion': ('django.db.models.fields.TextField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'paciente': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'incapacidades'", 'to': u"orm['clinique.Paciente']"})
        },
        ...
        u'clinique.reporte': {
            'Meta': {'ordering': "('-modified', '-created')", 'object_name': 'Reporte'},
            'archivo': ('django.db.models.fields.files.FileField', [], {'max_length': '100'}),
            'consultorio': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'reportes'", 'null': 'True', 'to': u"orm['clinique.Consultorio']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'})
        },

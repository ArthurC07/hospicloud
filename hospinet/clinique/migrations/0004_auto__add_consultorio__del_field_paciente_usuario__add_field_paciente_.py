...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'clinique_consultorio', (
            ...
            ('usuario', self.gf('django.db.models.fields.related.ForeignKey')(related_name='consultorios', to=orm['auth.User'])),
            ('secretaria', self.gf('django.db.models.fields.related.ForeignKey')(related_name='secretarias', to=orm['auth.User'])),
        ))
        db.send_create_signal(u'clinique', ['Consultorio'])

        # Deleting field 'Paciente.usuario'
        db.delete_column(u'clinique_paciente', 'usuario_id')

        # Adding field 'Paciente.consultorio'
        db.add_column(u'clinique_paciente', 'consultorio',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='pacientes', null=True, to=orm['clinique.Consultorio']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Paciente.usuario'
        raise RuntimeError("Cannot reverse this migration. 'Paciente.usuario' and its values cannot be restored.")
        # Deleting field 'Paciente.consultorio'
        db.delete_column(u'clinique_paciente', 'consultorio_id')

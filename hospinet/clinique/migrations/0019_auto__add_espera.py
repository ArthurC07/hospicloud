...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Espera'
        db.create_table(u'clinique_espera', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('consultorio', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='espera', null=True, to=orm['clinique.Consultorio'])),
            ('persona', self.gf('django.db.models.fields.related.ForeignKey')(related_name='espera', to=orm['persona.Persona'])),
        ...
        db.send_create_signal(u'clinique', ['Espera'])


    def backwards(self, orm):
        # Deleting model 'Espera'
        db.delete_table(u'clinique_espera')

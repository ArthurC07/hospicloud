...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Consulta.padecimiento'
        db.delete_column(u'clinique_consulta', 'padecimiento')


    def backwards(self, orm):
        # Adding field 'Consulta.padecimiento'
        db.add_column(u'clinique_consulta', 'padecimiento',

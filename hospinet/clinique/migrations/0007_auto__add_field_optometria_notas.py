...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Optometria.notas'
        db.add_column('clinique_optometria', 'notas', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Optometria.notas'
        db.delete_column('clinique_optometria', 'notas')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 12, 10, 30, 6, 955677)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 12, 10, 30, 6, 955532)'}),
        ...
        'clinique.cita': {
            ...
            'fecha_y_hora': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 12, 10, 30, 6, 852319)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

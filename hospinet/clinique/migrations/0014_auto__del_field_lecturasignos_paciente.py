...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'LecturaSignos.paciente'
        db.delete_column(u'clinique_lecturasignos', 'paciente_id')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'LecturaSignos.paciente'
        raise RuntimeError("Cannot reverse this migration. 'LecturaSignos.paciente' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'LecturaSignos.paciente'
        db.add_column(u'clinique_lecturasignos', 'paciente',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='signos_vitales', to=orm['clinique.Paciente']),
                      keep_default=False)

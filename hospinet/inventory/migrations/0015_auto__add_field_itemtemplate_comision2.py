...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ItemTemplate.comision2'
        db.add_column(u'inventory_itemtemplate', 'comision2',
                      self.gf('django.db.models.fields.DecimalField')(default='10.00', max_digits=4, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ItemTemplate.comision2'
        db.delete_column(u'inventory_itemtemplate', 'comision2')
    ...
    models = {
        ...
        u'inventory.historial': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'fecha': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 2, 26, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inventario': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'historiales'", 'to': u"orm['inventory.Inventario']"}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'})
        },

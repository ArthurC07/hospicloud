...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ItemComprado.item'
        db.add_column(u'inventory_itemcomprado', 'item',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='comprado', null=True, to=orm['inventory.ItemTemplate']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ItemComprado.item'
        db.delete_column(u'inventory_itemcomprado', 'item_id')

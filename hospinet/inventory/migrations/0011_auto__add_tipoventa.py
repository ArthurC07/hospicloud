...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'TipoVenta'
        db.create_table(u'inventory_tipoventa', (
            ...
            ('incremento', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2)),
            ('disminucion', self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=10, decimal_places=2)),
        ))
        db.send_create_signal(u'inventory', ['TipoVenta'])


    def backwards(self, orm):
        # Deleting model 'TipoVenta'
        db.delete_table(u'inventory_tipoventa')

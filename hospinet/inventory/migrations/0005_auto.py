...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field item_type on 'ItemTemplate'
        m2m_table_name = db.shorten_name(u'inventory_itemtemplate_item_type')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('itemtemplate', models.ForeignKey(orm[u'inventory.itemtemplate'], null=False)),
            ('itemtype', models.ForeignKey(orm[u'inventory.itemtype'], null=False))
        ))
        db.create_unique(m2m_table_name, ['itemtemplate_id', 'itemtype_id'])


    def backwards(self, orm):
        # Removing M2M table for field item_type on 'ItemTemplate'
        db.delete_table(db.shorten_name(u'inventory_itemtemplate_item_type'))

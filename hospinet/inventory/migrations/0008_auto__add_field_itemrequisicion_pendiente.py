...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ItemRequisicion.pendiente'
        db.add_column(u'inventory_itemrequisicion', 'pendiente',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ItemRequisicion.pendiente'
        db.delete_column(u'inventory_itemrequisicion', 'pendiente')

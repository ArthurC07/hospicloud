...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ItemTemplate.comision'
        db.add_column(u'inventory_itemtemplate', 'comision',
                      self.gf('django.db.models.fields.DecimalField')(default='30.00', max_digits=4, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ItemTemplate.comision'
        db.delete_column(u'inventory_itemtemplate', 'comision')

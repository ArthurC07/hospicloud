...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ItemComprado.cantidad'
        db.add_column(u'inventory_itemcomprado', 'cantidad',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ItemComprado.cantidad'
        db.delete_column(u'inventory_itemcomprado', 'cantidad')
    ...
    models = {
        ...
        u'inventory.historial': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'fecha': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 8, 2, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

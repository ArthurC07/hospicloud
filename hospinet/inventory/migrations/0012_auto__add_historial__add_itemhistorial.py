...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Historial'
        db.create_table(u'inventory_historial', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('inventario', self.gf('django.db.models.fields.related.ForeignKey')(related_name='historico', to=orm['inventory.Inventario'])),
            ('fecha', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 7, 31, 0, 0))),
        ))
        db.send_create_signal(u'inventory', ['Historial'])

        # Adding model 'ItemHistorial'
        db.create_table(u'inventory_itemhistorial', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('historial', self.gf('django.db.models.fields.related.ForeignKey')(related_name='items', to=orm['inventory.Historial'])),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(related_name='historicos', to=orm['inventory.ItemTemplate'])),
        ))
        db.send_create_signal(u'inventory', ['ItemHistorial'])


    def backwards(self, orm):
        # Deleting model 'Historial'
        db.delete_table(u'inventory_historial')

        # Deleting model 'ItemHistorial'
        db.delete_table(u'inventory_itemhistorial')
    ...
    models = {
        ...
        u'inventory.historial': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'fecha': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 7, 31, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

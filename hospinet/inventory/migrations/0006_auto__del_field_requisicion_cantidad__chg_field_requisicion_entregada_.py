...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Requisicion.cantidad'
        db.delete_column(u'inventory_requisicion', 'cantidad')


        # Changing field 'Requisicion.entregada'
        db.alter_column(u'inventory_requisicion', 'entregada', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Requisicion.aprobada'
        db.alter_column(u'inventory_requisicion', 'aprobada', self.gf('django.db.models.fields.NullBooleanField')(null=True))

    def backwards(self, orm):
        # Adding field 'Requisicion.cantidad'
        db.add_column(u'inventory_requisicion', 'cantidad',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


        # Changing field 'Requisicion.entregada'
        db.alter_column(u'inventory_requisicion', 'entregada', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Requisicion.aprobada'
        db.alter_column(u'inventory_requisicion', 'aprobada', self.gf('django.db.models.fields.BooleanField')())

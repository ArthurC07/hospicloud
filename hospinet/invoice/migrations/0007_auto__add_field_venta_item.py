...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Venta.item'
        db.add_column(u'invoice_venta', 'item',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='ventas', null=True, to=orm['inventory.ItemTemplate']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Venta.item'
        db.delete_column(u'invoice_venta', 'item_id')

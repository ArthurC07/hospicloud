...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Recibo.remite'
        db.add_column('invoice_recibo', 'remite',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Venta.descuento'
        db.add_column('invoice_venta', 'descuento',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Recibo.remite'
        db.delete_column('invoice_recibo', 'remite')

        # Deleting field 'Venta.descuento'
        db.delete_column('invoice_venta', 'descuento')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Recibo.radiologo'
        db.add_column('invoice_recibo', 'radiologo',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Producto.comision'
        db.add_column('invoice_producto', 'comision',
                      self.gf('django.db.models.fields.DecimalField')(default='30.00', max_digits=4, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Recibo.radiologo'
        db.delete_column('invoice_recibo', 'radiologo')

        # Deleting field 'Producto.comision'
        db.delete_column('invoice_producto', 'comision')
    ...
    models = {
        ...
        'invoice.recibo': {
            ...
            'radiologo': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'remite': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'})
        },
        'invoice.venta': {

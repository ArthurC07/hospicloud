...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Recibo'
        db.create_table('invoice_recibo', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('cliente', self.gf('django.db.models.fields.related.ForeignKey')(related_name='recibos', to=orm['persona.Persona'])),
            ('cerrado', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('nulo', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('cajero', self.gf('django.db.models.fields.related.ForeignKey')(related_name='recibos', to=orm['auth.User'])),
        ))
        db.send_create_signal('invoice', ['Recibo'])

        # Adding model 'Producto'
        db.create_table('invoice_producto', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
        ...
        db.send_create_signal('invoice', ['Producto'])

        # Adding model 'Venta'
        db.create_table('invoice_venta', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('cantidad', self.gf('django.db.models.fields.IntegerField')()),
            ('descripcion', self.gf('django.db.models.fields.TextField')()),
            ('producto', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ventas', to=orm['invoice.Producto'])),
            ('recibo', self.gf('django.db.models.fields.related.ForeignKey')(related_name='ventas', to=orm['invoice.Recibo'])),
        ))
        db.send_create_signal('invoice', ['Venta'])


    def backwards(self, orm):
        # Deleting model 'Recibo'
        db.delete_table('invoice_recibo')

        # Deleting model 'Producto'
        db.delete_table('invoice_producto')

        # Deleting model 'Venta'
        db.delete_table('invoice_venta')
    ...
    models = {
        ...
        'invoice.recibo': {
            ...
            'cajero': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'recibos'", 'to': "orm['auth.User']"}),
            'cerrado': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'cliente': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'recibos'", 'to': "orm['persona.Persona']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
        ...
        'invoice.venta': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'producto': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'ventas'", 'to': "orm['invoice.Producto']"}),
            'recibo': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'ventas'", 'to': "orm['invoice.Recibo']"})
        },
        'persona.persona': {

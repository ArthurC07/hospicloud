...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'invoice_producto')


        # Changing field 'Recibo.cajero'
        db.alter_column(u'invoice_recibo', 'cajero_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['auth.User']))

    def backwards(self, orm):
        # Adding model 'Producto'
        db.create_table(u'invoice_producto', (
            ...
            ('comision', self.gf('django.db.models.fields.DecimalField')(default='30.00', max_digits=4, decimal_places=2)),
        ))
        db.send_create_signal(u'invoice', ['Producto'])


        # Changing field 'Recibo.cajero'
        db.alter_column(u'invoice_recibo', 'cajero_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']))

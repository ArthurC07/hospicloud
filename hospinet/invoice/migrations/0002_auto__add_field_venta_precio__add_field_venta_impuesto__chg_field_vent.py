...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Venta.precio'
        db.add_column('invoice_venta', 'precio',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2, blank=True),
                      keep_default=False)

        # Adding field 'Venta.impuesto'
        db.add_column('invoice_venta', 'impuesto',
                      self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2, blank=True),
                      keep_default=False)


        # Changing field 'Venta.descripcion'
        db.alter_column('invoice_venta', 'descripcion', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):
        # Deleting field 'Venta.precio'
        db.delete_column('invoice_venta', 'precio')

        # Deleting field 'Venta.impuesto'
        db.delete_column('invoice_venta', 'impuesto')


        # Changing field 'Venta.descripcion'
        db.alter_column('invoice_venta', 'descripcion', self.gf('django.db.models.fields.TextField')(default=''))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Recibo.tipo_de_venta'
        db.add_column(u'invoice_recibo', 'tipo_de_venta',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.TipoVenta'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Recibo.tipo_de_venta'
        db.delete_column(u'invoice_recibo', 'tipo_de_venta_id')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'invoice_tipopago', (
        ...
        db.send_create_signal(u'invoice', ['TipoPago'])

        # Adding model 'Pago'
        db.create_table(u'invoice_pago', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('tipo', self.gf('django.db.models.fields.related.ForeignKey')(related_name='pagos', to=orm['invoice.TipoPago'])),
            ('recibo', self.gf('django.db.models.fields.related.ForeignKey')(related_name='pagos', to=orm['invoice.Recibo'])),
            ('monto', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=7, decimal_places=2, blank=True)),
        ))
        db.send_create_signal(u'invoice', ['Pago'])


    def backwards(self, orm):
        # Deleting model 'TipoPago'
        db.delete_table(u'invoice_tipopago')

        # Deleting model 'Pago'
        db.delete_table(u'invoice_pago')

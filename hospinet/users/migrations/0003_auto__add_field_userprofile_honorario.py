...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserProfile.honorario'
        db.add_column(u'users_userprofile', 'honorario',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='usuarios', null=True, to=orm['inventory.ItemTemplate']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserProfile.honorario'
        db.delete_column(u'users_userprofile', 'honorario_id')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'users_userprofile', 'id', self.gf('django.db.models.fields.related.OneToOneField')(default=0, to=orm['auth.User'], unique=True, db_column='id'))

    def backwards(self, orm):

        # Changing field 'UserProfile.id'
        db.alter_column(u'users_userprofile', 'id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, null=True, db_column='id'))
    ...
    models = {
        ...
        u'users.userprofile': {
            ...
            'id': ('django.db.models.fields.related.OneToOneField', [], {'to': u"orm['auth.User']", 'unique': 'True', 'db_column': "'id'"}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.id'
        db.alter_column(u'users_userprofile', 'id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, primary_key=True, db_column='id', to=orm['auth.User']))

    def backwards(self, orm):

        # Changing field 'UserProfile.user'
        db.alter_column(u'users_userprofile', 'user_id', self.gf('django.db.models.fields.related.OneToOneField')(unique=True, primary_key=True, to=orm['auth.User']))

        # Changing field 'UserProfile.id'
        db.alter_column(u'users_userprofile', 'id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True, db_column='id'))
    ...
    models = {
        ...
        u'users.userprofile': {
            ...
            'id': ('django.db.models.fields.related.OneToOneField', [], {'related_name': "'profile'", 'unique': 'True', 'primary_key': 'True', 'db_column': "'id'", 'to': u"orm['auth.User']"}),

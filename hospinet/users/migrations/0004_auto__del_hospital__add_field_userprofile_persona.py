...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'users_hospital')

        # Adding field 'UserProfile.persona'
        db.add_column(u'users_userprofile', 'persona',
                      self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='profile', unique=True, null=True, to=orm['persona.Persona']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding model 'Hospital'
        db.create_table(u'users_hospital', (
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=200)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'users', ['Hospital'])

        # Deleting field 'UserProfile.persona'
        db.delete_column(u'users_userprofile', 'persona_id')

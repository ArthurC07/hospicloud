...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'TipoExamen.item'
        db.add_column(u'imaging_tipoexamen', 'item',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.ItemTemplate'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Examen.facturado'
        db.add_column(u'imaging_examen', 'facturado',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'TipoExamen.item'
        db.delete_column(u'imaging_tipoexamen', 'item_id')

        # Deleting field 'Examen.facturado'
        db.delete_column(u'imaging_examen', 'facturado')

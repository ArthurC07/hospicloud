...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EstudioProgramado.tipo_de_venta'
        db.add_column(u'imaging_estudioprogramado', 'tipo_de_venta',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='estudios', to=orm['inventory.TipoVenta']),
                      keep_default=False)

        # Adding field 'Examen.tipo_de_venta'
        db.add_column(u'imaging_examen', 'tipo_de_venta',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='examenes', to=orm['inventory.TipoVenta']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EstudioProgramado.tipo_de_venta'
        db.delete_column(u'imaging_estudioprogramado', 'tipo_de_venta_id')

        # Deleting field 'Examen.tipo_de_venta'
        db.delete_column(u'imaging_examen', 'tipo_de_venta_id')
    ...
    models = {
        ...
        u'imaging.estudioprogramado': {
            ...
            'radiologo': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Radiologo'
        db.create_table(u'imaging_radiologo', (
        ...
        db.send_create_signal(u'imaging', ['Radiologo'])

        # Deleting field 'Examen.radiologo'
        db.delete_column(u'imaging_examen', 'radiologo')


    def backwards(self, orm):
        # Deleting model 'Radiologo'
        db.delete_table(u'imaging_radiologo')

        # Adding field 'Examen.radiologo'
        db.add_column(u'imaging_examen', 'radiologo',

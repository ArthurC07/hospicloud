...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'imaging_estudioprogramado', 'radiologo',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='estudios', to=orm['imaging.Radiologo']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EstudioProgramado.radiologo'
        db.delete_column(u'imaging_estudioprogramado', 'radiologo_id')

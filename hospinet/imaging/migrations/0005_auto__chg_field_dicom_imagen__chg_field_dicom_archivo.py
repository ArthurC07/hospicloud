...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'imaging_dicom', 'archivo', self.gf('django.db.models.fields.files.FileField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Dicom.imagen'
        db.alter_column(u'imaging_dicom', 'imagen', self.gf('private_files.models.fields.PrivateFileField')(max_length=100))

        # Changing field 'Dicom.archivo'
        db.alter_column(u'imaging_dicom', 'archivo', self.gf('private_files.models.fields.PrivateFileField')(max_length=100))

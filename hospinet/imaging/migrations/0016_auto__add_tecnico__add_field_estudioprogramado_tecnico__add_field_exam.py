...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'imaging_tecnico', (
            ...
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.ItemTemplate'], null=True, blank=True)),
            ('porcentaje', self.gf('django.db.models.fields.IntegerField')(default=10)),
        ))
        db.send_create_signal(u'imaging', ['Tecnico'])

        # Adding field 'EstudioProgramado.tecnico'
        db.add_column(u'imaging_estudioprogramado', 'tecnico',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='estudios', null=True, to=orm['imaging.Tecnico']),
                      keep_default=False)

        # Adding field 'Examen.tecnico'
        db.add_column(u'imaging_examen', 'tecnico',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='examenes', null=True, to=orm['imaging.Tecnico']),
                      keep_default=False)

        # Adding field 'Radiologo.porcentaje'
        db.add_column(u'imaging_radiologo', 'porcentaje',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'imaging_tecnico')

        # Deleting field 'EstudioProgramado.tecnico'
        db.delete_column(u'imaging_estudioprogramado', 'tecnico_id')

        # Deleting field 'Examen.tecnico'
        db.delete_column(u'imaging_examen', 'tecnico_id')

        # Deleting field 'Radiologo.porcentaje'
        db.delete_column(u'imaging_radiologo', 'porcentaje')
    ...
    models = {
        ...
        u'imaging.estudioprogramado': {
            ...
            'radiologo': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'estudios'", 'to': u"orm['imaging.Radiologo']"}),
            'remitio': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'tecnico': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'estudios'", 'null': 'True', 'to': u"orm['imaging.Tecnico']"}),
        ...
        u'imaging.examen': {
            ...
            'tecnico': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'examenes'", 'null': 'True', 'to': u"orm['imaging.Tecnico']"}),
        ...
        u'imaging.radiologo': {
            ...
            'porcentaje': ('django.db.models.fields.IntegerField', [], {'default': '30'})
        },
        u'imaging.tecnico': {
            'Meta': {'ordering': "('-modified', '-created')", 'object_name': 'Tecnico'},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'item': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['inventory.ItemTemplate']", 'null': 'True', 'blank': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'nombre': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'porcentaje': ('django.db.models.fields.IntegerField', [], {'default': '10'})
        },

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'imaging_examen', 'radiologo',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='examenes', to=orm['imaging.Radiologo']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Examen.radiologo'
        db.delete_column(u'imaging_examen', 'radiologo_id')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'imaging_estudio', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('examen', self.gf('django.db.models.fields.related.ForeignKey')(related_name='estudios', to=orm['imaging.Examen'])),
            ('tipo_de_examen', self.gf('django.db.models.fields.related.ForeignKey')(related_name='estudios', to=orm['imaging.TipoExamen'])),
        ))
        db.send_create_signal(u'imaging', ['Estudio'])


    def backwards(self, orm):
        # Deleting model 'Estudio'
        db.delete_table(u'imaging_estudio')

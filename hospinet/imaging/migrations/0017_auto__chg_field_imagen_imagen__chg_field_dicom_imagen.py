...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'imaging_imagen', 'imagen', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

        # Changing field 'Dicom.imagen'
        db.alter_column(u'imaging_dicom', 'imagen', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Imagen.imagen'
        db.alter_column(u'imaging_imagen', 'imagen', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))

        # Changing field 'Dicom.imagen'
        db.alter_column(u'imaging_dicom', 'imagen', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Examen.uuid'
        db.add_column('laboratory_examen', 'uuid',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=36, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Examen.uuid'
        db.delete_column('laboratory_examen', 'uuid')
    ...
    models = {
        ...
        'laboratory.dicom': {
            ...
            'descripcion': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'examen': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'dicoms'", 'to': "orm['laboratory.Examen']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

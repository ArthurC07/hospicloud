...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LimiteEvento'
        db.create_table(u'contracts_limiteevento', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('plan', self.gf('django.db.models.fields.related.ForeignKey')(related_name='limites', to=orm['contracts.Plan'])),
            ('tipo_evento', self.gf('django.db.models.fields.related.ForeignKey')(related_name='limites', to=orm['contracts.TipoEvento'])),
            ('cantidad', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'contracts', ['LimiteEvento'])

        # Deleting field 'Plan.eventos_maximos'
        db.delete_column(u'contracts_plan', 'eventos_maximos')

        # Adding field 'Evento.adjunto'
        db.add_column(u'contracts_evento', 'adjunto',
                      self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'LimiteEvento'
        db.delete_table(u'contracts_limiteevento')

        # Adding field 'Plan.eventos_maximos'
        db.add_column(u'contracts_plan', 'eventos_maximos',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

        # Deleting field 'Evento.adjunto'
        db.delete_column(u'contracts_evento', 'adjunto')
    ...
    models = {
        ...
        u'contracts.beneficiario': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inscripcion': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 27, 0, 0)'}),
        ...
        u'contracts.contrato': {
            ...
            'ultimo_pago': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 27, 0, 0)'}),
        ...
        u'contracts.evento': {
            ...
            'fecha': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 3, 27, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Beneficiario.inscripcion'
        db.add_column(u'contracts_beneficiario', 'inscripcion',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2014, 2, 21, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Beneficiario.inscripcion'
        db.delete_column(u'contracts_beneficiario', 'inscripcion')
    ...
    models = {
        ...
        u'contracts.beneficiario': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inscripcion': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 21, 0, 0)'}),
        ...
        u'contracts.contrato': {
            ...
            'ultimo_pago': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 21, 0, 0)'}),
        ...
        u'contracts.evento': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'fecha': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 2, 21, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'contracts_tipopago', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('item', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tipos_pago', to=orm['inventory.ItemTemplate'])),
        ))
        db.send_create_signal(u'contracts', ['TipoPago'])

        # Adding field 'Pago.tipo_de_pago'
        db.add_column(u'contracts_pago', 'tipo_de_pago',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='pagos', null=True, to=orm['contracts.TipoPago']),
                      keep_default=False)

        # Adding field 'Pago.descripcion'
        db.add_column(u'contracts_pago', 'descripcion',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Pago.facturar'
        db.add_column(u'contracts_pago', 'facturar',
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'contracts_tipopago')

        # Deleting field 'Pago.tipo_de_pago'
        db.delete_column(u'contracts_pago', 'tipo_de_pago_id')

        # Deleting field 'Pago.descripcion'
        db.delete_column(u'contracts_pago', 'descripcion')

        # Deleting field 'Pago.facturar'
        db.delete_column(u'contracts_pago', 'facturar')
    ...
    models = {
        ...
        u'contracts.beneficiario': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inscripcion': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 1, 0, 0)'}),
        ...
        u'contracts.contrato': {
            ...
            'ultimo_pago': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 1, 0, 0)'}),
        ...
        u'contracts.evento': {
            ...
            'fecha': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 1, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'contracts_autorizacion', (
            ...
            ('vigente', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'contracts', ['Autorizacion'])

        # Adding model 'Precontrato'
        db.create_table(u'contracts_precontrato', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('persona', self.gf('django.db.models.fields.related.ForeignKey')(related_name='precontratos', to=orm['persona.Persona'])),
            ('completado', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('de_acuerdo', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal(u'contracts', ['Precontrato'])

        # Adding model 'Prebeneficiario'
        db.create_table(u'contracts_prebeneficiario', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('precontrato', self.gf('django.db.models.fields.related.ForeignKey')(related_name='prebeneficiarios', to=orm['contracts.Precontrato'])),
            ('persona', self.gf('django.db.models.fields.related.ForeignKey')(related_name='prebeneficiarios', to=orm['persona.Persona'])),
        ))
        db.send_create_signal(u'contracts', ['Prebeneficiario'])


    def backwards(self, orm):
        # Deleting model 'Autorizacion'
        db.delete_table(u'contracts_autorizacion')

        # Deleting model 'Precontrato'
        db.delete_table(u'contracts_precontrato')

        # Deleting model 'Prebeneficiario'
        db.delete_table(u'contracts_prebeneficiario')
    ...
    models = {
        ...
        u'contracts.autorizacion': {
            'Meta': {'ordering': "('-modified', '-created')", 'object_name': 'Autorizacion'},
        ...
        u'contracts.beneficiario': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inscripcion': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 16, 0, 0)'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
        ...
        u'contracts.cancelacion': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'fecha': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 6, 16, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
        ...
        u'contracts.contrato': {
            ...
            'ultimo_pago': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 16, 0, 0)'}),
        ...
        u'contracts.evento': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'descripcion': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'fecha': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 6, 16, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
        ...
        u'contracts.plan': {
            ...
            'comision': ('django.db.models.fields.DecimalField', [], {'default': '0', 'max_digits': '10', 'decimal_places': '2'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
        ...
        u'contracts.prebeneficiario': {
            'Meta': {'ordering': "('-modified', '-created')", 'object_name': 'Prebeneficiario'},
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'persona': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'prebeneficiarios'", 'to': u"orm['persona.Persona']"}),
            'precontrato': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'prebeneficiarios'", 'to': u"orm['contracts.Precontrato']"})
        },
        u'contracts.precontrato': {
            'Meta': {'ordering': "('-modified', '-created')", 'object_name': 'Precontrato'},
            'completado': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'de_acuerdo': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'persona': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'precontratos'", 'to': u"orm['persona.Persona']"})
        },

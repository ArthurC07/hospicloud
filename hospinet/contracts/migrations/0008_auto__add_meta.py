...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Meta'
        db.create_table(u'contracts_meta', (
            ...
            ('contratos', self.gf('django.db.models.fields.IntegerField')()),
        ))
        db.send_create_signal(u'contracts', ['Meta'])


    def backwards(self, orm):
        # Deleting model 'Meta'
        db.delete_table(u'contracts_meta')

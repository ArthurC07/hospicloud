...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'contracts_metodopago', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('nombre', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal(u'contracts', ['MetodoPago'])

        # Adding field 'Precontrato.metodo_de_pago'
        db.add_column(u'contracts_precontrato', 'metodo_de_pago',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='precontratos', null=True, to=orm['contracts.MetodoPago']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'MetodoPago'
        db.delete_table(u'contracts_metodopago')

        # Deleting field 'Precontrato.metodo_de_pago'
        db.delete_column(u'contracts_precontrato', 'metodo_de_pago_id')

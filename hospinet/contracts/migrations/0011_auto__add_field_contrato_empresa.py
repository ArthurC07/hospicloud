...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Contrato.empresa'
        db.add_column(u'contracts_contrato', 'empresa',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='contratos', null=True, to=orm['persona.Empleador']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Contrato.empresa'
        db.delete_column(u'contracts_contrato', 'empresa_id')
    ...
    models = {
        ...
        u'contracts.beneficiario': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inscripcion': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 9, 0, 0)'}),
        ...
        u'contracts.cancelacion': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'fecha': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 4, 9, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
        ...
        u'contracts.contrato': {
            ...
            'ultimo_pago': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 9, 0, 0)'}),
        ...
        u'contracts.evento': {
            ...
            'fecha': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 9, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),

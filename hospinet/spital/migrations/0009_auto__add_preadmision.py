...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PreAdmision'
        db.create_table(u'spital_preadmision', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('emergencia', self.gf('django.db.models.fields.related.ForeignKey')(related_name='preadmisiones', to=orm['emergency.Emergencia'])),
            ('completada', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'spital', ['PreAdmision'])


    def backwards(self, orm):
        # Deleting model 'PreAdmision'
        db.delete_table(u'spital_preadmision')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Admision.neonato'
        db.add_column('spital_admision', 'neonato', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Admision.neonato'
        db.delete_column('spital_admision', 'neonato')

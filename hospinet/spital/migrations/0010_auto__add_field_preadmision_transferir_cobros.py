...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PreAdmision.transferir_cobros'
        db.add_column(u'spital_preadmision', 'transferir_cobros',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PreAdmision.transferir_cobros'
        db.delete_column(u'spital_preadmision', 'transferir_cobros')

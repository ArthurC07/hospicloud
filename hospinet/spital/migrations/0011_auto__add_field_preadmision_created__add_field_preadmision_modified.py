...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PreAdmision.created'
        db.add_column(u'spital_preadmision', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'PreAdmision.modified'
        db.add_column(u'spital_preadmision', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PreAdmision.created'
        db.delete_column(u'spital_preadmision', 'created')

        # Deleting field 'PreAdmision.modified'
        db.delete_column(u'spital_preadmision', 'modified')

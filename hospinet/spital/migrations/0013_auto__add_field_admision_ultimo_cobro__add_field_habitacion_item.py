...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Admision.ultimo_cobro'
        db.add_column(u'spital_admision', 'ultimo_cobro',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Habitacion.item'
        db.add_column(u'spital_habitacion', 'item',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='habitaciones', null=True, to=orm['inventory.ItemTemplate']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Admision.ultimo_cobro'
        db.delete_column(u'spital_admision', 'ultimo_cobro')

        # Deleting field 'Habitacion.item'
        db.delete_column(u'spital_habitacion', 'item_id')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Admision.qr'
        db.delete_column('spital_admision', 'qr')

        # Deleting field 'Admision.codigo'
        db.delete_column('spital_admision', 'codigo')


    def backwards(self, orm):
        # Adding field 'Admision.qr'
        db.add_column('spital_admision', 'qr',
                      self.gf('sorl.thumbnail.fields.ImageField')(default='', max_length=100, blank=True),
                      keep_default=False)

        # Adding field 'Admision.codigo'
        db.add_column('spital_admision', 'codigo',
                      self.gf('sorl.thumbnail.fields.ImageField')(default=0, max_length=100, blank=True),
                      keep_default=False)

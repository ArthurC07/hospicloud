...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Admision.tipo_de_venta'
        db.add_column(u'spital_admision', 'tipo_de_venta',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['inventory.TipoVenta'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Admision.tipo_de_venta'
        db.delete_column(u'spital_admision', 'tipo_de_venta_id')

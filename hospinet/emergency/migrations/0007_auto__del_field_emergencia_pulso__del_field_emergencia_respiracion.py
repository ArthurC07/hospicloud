...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'emergency_emergencia', 'pulso')

        # Deleting field 'Emergencia.respiracion'
        db.delete_column(u'emergency_emergencia', 'respiracion')


    def backwards(self, orm):
        # Adding field 'Emergencia.pulso'
        db.add_column(u'emergency_emergencia', 'pulso',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Emergencia.respiracion'
        db.add_column(u'emergency_emergencia', 'respiracion',

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Emergencia.presion'
        db.alter_column('emergency_emergencia', 'presion', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Emergencia.presion'
        db.alter_column('emergency_emergencia', 'presion', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Cobro.facturado'
        db.add_column(u'emergency_cobro', 'facturado',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Emergencia.facturada'
        db.add_column(u'emergency_emergencia', 'facturada',
                      self.gf('django.db.models.fields.NullBooleanField')(default=False, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Cobro.facturado'
        db.delete_column(u'emergency_cobro', 'facturado')

        # Deleting field 'Emergencia.facturada'
        db.delete_column(u'emergency_emergencia', 'facturada')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AntecedenteFamiliar.alcoholismo'
        db.alter_column(u'persona_antecedentefamiliar', 'alcoholismo', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'AntecedenteFamiliar.cancer'
        db.alter_column(u'persona_antecedentefamiliar', 'cancer', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'AntecedenteFamiliar.dislipidemias'
        db.alter_column(u'persona_antecedentefamiliar', 'dislipidemias', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'AntecedenteFamiliar.obesidad'
        db.alter_column(u'persona_antecedentefamiliar', 'obesidad', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'AntecedenteFamiliar.migrana'
        db.alter_column(u'persona_antecedentefamiliar', 'migrana', self.gf('django.db.models.fields.BooleanField')())

    def backwards(self, orm):

        # Changing field 'AntecedenteFamiliar.alcoholismo'
        db.alter_column(u'persona_antecedentefamiliar', 'alcoholismo', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'AntecedenteFamiliar.cancer'
        db.alter_column(u'persona_antecedentefamiliar', 'cancer', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'AntecedenteFamiliar.dislipidemias'
        db.alter_column(u'persona_antecedentefamiliar', 'dislipidemias', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'AntecedenteFamiliar.obesidad'
        db.alter_column(u'persona_antecedentefamiliar', 'obesidad', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'AntecedenteFamiliar.migrana'
        db.alter_column(u'persona_antecedentefamiliar', 'migrana', self.gf('django.db.models.fields.NullBooleanField')(null=True))

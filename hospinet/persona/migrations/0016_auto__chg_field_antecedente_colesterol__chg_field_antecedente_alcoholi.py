...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Antecedente.colesterol'
        db.alter_column(u'persona_antecedente', 'colesterol', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Antecedente.alcoholismo'
        db.alter_column(u'persona_antecedente', 'alcoholismo', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Antecedente.cancer'
        db.alter_column(u'persona_antecedente', 'cancer', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Antecedente.migrana'
        db.alter_column(u'persona_antecedente', 'migrana', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Antecedente.trigliceridos'
        db.alter_column(u'persona_antecedente', 'trigliceridos', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'Antecedente.obesidad'
        db.alter_column(u'persona_antecedente', 'obesidad', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'AntecedenteFamiliar.epoc'
        db.alter_column(u'persona_antecedentefamiliar', 'epoc', self.gf('django.db.models.fields.BooleanField')())

    def backwards(self, orm):

        # Changing field 'Antecedente.colesterol'
        db.alter_column(u'persona_antecedente', 'colesterol', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Antecedente.alcoholismo'
        db.alter_column(u'persona_antecedente', 'alcoholismo', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Antecedente.cancer'
        db.alter_column(u'persona_antecedente', 'cancer', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Antecedente.migrana'
        db.alter_column(u'persona_antecedente', 'migrana', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Antecedente.trigliceridos'
        db.alter_column(u'persona_antecedente', 'trigliceridos', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'Antecedente.obesidad'
        db.alter_column(u'persona_antecedente', 'obesidad', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'AntecedenteFamiliar.epoc'
        db.alter_column(u'persona_antecedentefamiliar', 'epoc', self.gf('django.db.models.fields.NullBooleanField')(null=True))
    ...
    models = {
        ...
        u'persona.antecedentefamiliar': {
            ...
            'epoc': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'general': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
            'hipertension': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'migrana': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'nutricional': ('django.db.models.fields.CharField', [], {'max_length': '200', 'blank': 'True'}),
        ...
        u'persona.antecedenteobstetrico': {
            ...
            'persona': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'antecedente_obstetrico'", 'primary_key': 'True', 'to': u"orm['persona.Persona']"}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Antecedente.alcoholismo'
        db.add_column(u'persona_antecedente', 'alcoholismo',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Antecedente.alcoholismo'
        db.delete_column(u'persona_antecedente', 'alcoholismo')

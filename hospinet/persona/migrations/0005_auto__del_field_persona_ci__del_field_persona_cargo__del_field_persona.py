...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Persona.ci'
        db.delete_column(u'persona_persona', 'ci')

        # Deleting field 'Persona.cargo'
        db.delete_column(u'persona_persona', 'cargo')

        # Deleting field 'Persona.tel_trabajo'
        db.delete_column(u'persona_persona', 'tel_trabajo')

        # Deleting field 'Persona.centro_trabajo'
        db.delete_column(u'persona_persona', 'centro_trabajo')

        # Deleting field 'Persona.antiguedad'
        db.delete_column(u'persona_persona', 'antiguedad')

        # Deleting field 'Persona.direccion_trabajo'
        db.delete_column(u'persona_persona', 'direccion_trabajo')


    def backwards(self, orm):
        # Adding field 'Persona.ci'
        db.add_column(u'persona_persona', 'ci',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Persona.cargo'
        db.add_column(u'persona_persona', 'cargo',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Persona.tel_trabajo'
        db.add_column(u'persona_persona', 'tel_trabajo',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Persona.centro_trabajo'
        db.add_column(u'persona_persona', 'centro_trabajo',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Persona.antiguedad'
        db.add_column(u'persona_persona', 'antiguedad',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

        # Adding field 'Persona.direccion_trabajo'
        db.add_column(u'persona_persona', 'direccion_trabajo',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)

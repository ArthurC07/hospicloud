...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Persona.fotografia'
        db.alter_column(u'persona_persona', 'fotografia', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Persona.fotografia'
        db.alter_column(u'persona_persona', 'fotografia', self.gf('sorl.thumbnail.fields.ImageField')(default='', max_length=100))

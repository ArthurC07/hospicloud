...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Sede'
        db.create_table(u'persona_sede', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('empleador', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='sedes', null=True, to=orm['persona.Empleador'])),
            ('lugar', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
            ('direccion', self.gf('django.db.models.fields.TextField')()),
        ))
        db.send_create_signal(u'persona', ['Sede'])

        # Deleting field 'Empleo.telefono'
        db.delete_column(u'persona_empleo', 'telefono')

        # Deleting field 'Empleo.direccion'
        db.delete_column(u'persona_empleo', 'direccion')

        # Adding field 'Empleo.numero_empleado'
        db.add_column(u'persona_empleo', 'numero_empleado',
    ...
    def backwards(self, orm):
        # Deleting model 'Sede'
        db.delete_table(u'persona_sede')

        # Adding field 'Empleo.telefono'
        db.add_column(u'persona_empleo', 'telefono',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True),
                      keep_default=False)


        # User chose to not deal with backwards NULL issues for 'Empleo.direccion'
        raise RuntimeError("Cannot reverse this migration. 'Empleo.direccion' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Empleo.direccion'
        db.add_column(u'persona_empleo', 'direccion',
                      self.gf('django.db.models.fields.TextField')(),
                      keep_default=False)

        # Deleting field 'Empleo.numero_empleado'
        db.delete_column(u'persona_empleo', 'numero_empleado')

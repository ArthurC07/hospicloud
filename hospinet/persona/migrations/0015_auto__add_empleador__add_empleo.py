...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Empleador'
        db.create_table(u'persona_empleador', (
        ...
        db.send_create_signal(u'persona', ['Empleador'])

        # Adding model 'Empleo'
        db.create_table(u'persona_empleo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True)),
            ('empleador', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='empleos', null=True, to=orm['persona.Empleador'])),
            ('persona', self.gf('django.db.models.fields.related.ForeignKey')(related_name='empleos', to=orm['persona.Persona'])),
            ('direccion', self.gf('django.db.models.fields.TextField')()),
            ('telefono', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True)),
        ))
        db.send_create_signal(u'persona', ['Empleo'])


    def backwards(self, orm):
        # Deleting model 'Empleador'
        db.delete_table(u'persona_empleador')

        # Deleting model 'Empleo'
        db.delete_table(u'persona_empleo')

...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('budget', '0001_squashed_0015_auto_20150907_0925'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('anio', models.IntegerField(help_text='A\xf1o')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('presupuesto', models.ForeignKey(to='budget.PresupuestoMensual')),
            ],
            options={
                'ordering': ('-modified', '-created'),
                'abstract': False,
        ...
        migrations.AddField(
            model_name='concepto',
            name='rubro',
            field=models.ForeignKey(to='budget.Rubro'),
        ),
    ]
